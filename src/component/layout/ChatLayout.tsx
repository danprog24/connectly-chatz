...
//   return (
//     <div className="flex flex-col h-[100dvh] min-w-0 overflow-hidden" style={{ background: "#0b141a" }}>
...
const ChatLayout: React.FC<Props> = ({ onBack }) => {
  ...
  return (
    <div className="flex flex-col h-[100dvh] w-full min-w-0 overflow-hidden bg-[#0b141a]">
      ...
      {/* Messages (ONLY this section should grow) */}
